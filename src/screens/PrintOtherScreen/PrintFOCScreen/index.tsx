...
const PrintFOC = () => {
    ...
    const handleSearch = () => {
        ...
        setDisabled(true)
        const url = connect_string + "api/Search_Material_Data"
        const data = {
            txtSuplier: supplier,
    ...
    const handleDoubleClick = (colName: string, params: any) => {
        setDisabled(true)
        const url = connect_string + "api/CellMouseDoubleClickFOC"
        const data =
        {
    ...
    const handleDelete = () => {
        const url = connect_string + "api/btnDelete_ClickFOC"
    ...
    const handlePrintOK = () => {
        setDisabled(true)
        handleOpenConfirm('print')
        const url = connect_string + "api/Print_FOC_Click"
        const arr = listChx.map((item: any) => item.Barcode)
        const data =
        {
            dcpCheck: true,
    ...
    return (
        <FullScreenContainerWithNavBar
            sideBarDisable={true}
            sideBarNavigate=""
            title={t("lblPrint_FOC") as string}
            navigate={"/"}
